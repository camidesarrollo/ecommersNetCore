/* =====================================================
   TOUR GUIADO - EDITAR MESTRO DE ATRIBUTOS
   js/application/masterAttributes/edit.js (ACTUALIZADO)
===================================================== */

import Shepherd from "../../bundle/vendors_shepherd.js";
import { masterAttributesUpdateSchema } from "../../bundle/schema/master.attributes.update.shema.js";
import {
    initBlurValidation,
...
===================================================== */
function initMasterAttributesUpdateTour() {
    ...
    tour.addStep({
        ...
        text: `
            <p>👋 Este tour te ayudará a editar atributos dinámicos para tus productos.</p>
            <p>Aprenderás a:</p>
            <ul>
    ...
    // =========================================
    tour.on('complete', () => {
        localStorage.setItem('masterAttributesUpdateTourCompleted', 'true');
        console.log('✅ Tour Maestro de Atributos completado');
    });

    tour.on('cancel', () => {
        localStorage.setItem('masterAttributesUpdateTourCancelled', 'true');
...
function shouldShowTour() {
    const completed = localStorage.getItem('masterAttributesUpdateTourCompleted');
    const cancelled = localStorage.getItem('masterAttributesUpdateTourCancelled');
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tour = initMasterAttributesUpdateTour();
    ...
    window.masterAttributesUpdateTour = tour;
});
...
console.log("Schema cargado:", masterAttributesUpdateSchema);
initBlurValidation({
    form,
    schema: masterAttributesUpdateSchema
});
...
form.addEventListener("submit", async function (e) {
    ...
    const data = castFormDataBySchema(formData, masterAttributesUpdateSchema);

    try {
        const validated = await masterAttributesUpdateSchema.parseAsync(data);
