/* js\application\categorias\edit.js */
import Shepherd from "../../bundle/vendors_shepherd.js";
import { categoriesUpdateSchema } from "../../bundle/schema/categories.update.shema.js";
import {
    initBlurValidation,
...
===================================================== */
function initCategoryUpdateTour() {
    ...
    tour.addStep({
        id: 'welcome',
        title: '¡Bienvenido al Editor de Categorías!',
        text: `
            <p>👋 Te guiaremos paso a paso para editar una categoría correctamente.</p>
            <ul>
...
function shouldShowTour() {
    const completed = localStorage.getItem('categoriasUpdateTourCompleted');
    const cancelled = localStorage.getItem('categoriasUpdateTourCancelled');
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tour = initCategoryUpdateTour();
    ...
    window.categoriasUpdateTour = tour;
});
...
handleZodFormSubmit({
    form,
    schema: categoriesUpdateSchema,
    castSchema: categoriesUpdateSchema,
